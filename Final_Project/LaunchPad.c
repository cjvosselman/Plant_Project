...
void motor0_pwm_init(uint32_t load_value, uint32_t compare_value)
{
  ...
  TIMA0->COUNTERREGS.CC_23[0] = GPTIMER_CC_23_CCVAL_MASK & compare_value;
...
{
  TIMA0->COUNTERREGS.CC_23[0] = GPTIMER_CC_23_CCVAL_MASK & count;
